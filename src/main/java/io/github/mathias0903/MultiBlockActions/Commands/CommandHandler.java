...
import static io.github.mathias0903.MultiBlockActions.misc.Utils.lang;
...
public class CommandHandler implements CommandExecutor
{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        ...
        if(sender instanceof Player) {
            ...
            if(args.length == 0) {
                getExecutor("example").onCommand(sender, args);
                return true;
            }
            ...
            if(args.length > 0) {
                ...
                if(exists(args[0])){
                    ...
                    sender.sendMessage(lang("This command doesn't exist!"));
                    return true;
                }
            }
        } else {
